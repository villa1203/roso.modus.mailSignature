...
}), Fo = `.v-mail-signature-generator[data-v-1507fcdd]{--wcm-line-height: 20px;--wcm-font-size: 18px;max-width:30em;font-family:sans-serif;min-height:calc(100vh - 200px);padding-bottom:var(--wcm-line-height);font-size:var(--wcm-font-size);line-height:var(--wcm-line-height);margin:auto}.v-mail-signature-generator .v-mail-signature-generator__container[data-v-1507fcdd]{padding:var(--wcm-line-height);margin-bottom:var(--wcm-line-height);background:white}.v-mail-signature-generator .v-mail-signature-generator__container>*[data-v-1507fcdd]::-moz-selection{color:#20b2aa;background:#b0fdf6}.v-mail-signature-generator .v-mail-signature-generator__container>*[data-v-1507fcdd] ::selection{color:#20b2aa;background:#b0fdf6}.v-mail-signature-generator .v-mail-signature-generator__container>table[data-v-1507fcdd]{pointer-events:none}h1[data-v-1507fcdd]{font-size:calc(var(--wcm-font-size) * 2);line-height:calc(var(--wcm-line-height) * 2)}.v-mail-signature-generator__child-no-margin>*[data-v-1507fcdd]:first-child{margin-top:0}.v-mail-signature-generator__child-no-margin>*[data-v-1507fcdd]:last-child{margin-bottom:0}.fp-grid-container[data-v-1507fcdd],.fp-ui-form[data-v-1507fcdd]{display:flex;flex-wrap:wrap}.fp-ui-form>input[data-v-1507fcdd]{all:unset;display:block;position:relative;width:100%;cursor:pointer;box-sizing:border-box;box-shadow:inset 0 0 0 2px currentColor;padding:calc(var(--wcm-line-height) / 2);margin-bottom:var(--wcm-line-height)}.fp-grid-coll-24-24[data-v-1507fcdd]{width:100%}.fp-ui-button[data-v-1507fcdd]{all:unset;line-height:var(--wcm-line-height);font-size:var(--wcm-font-size);font-weight:400;margin:0 auto;cursor:pointer;display:block;box-sizing:border-box;box-shadow:inset 0 0 0 2px currentColor;padding:calc(var(--wcm-line-height) / 2) calc(var(--wcm-line-height))}
`, Ko = (e, t) => {
  const n = e.__vccOpts || e;
  for (const [r, s] of t)
    n[r] = s;
  return n;
}, Oe = (e) => (mi("data-v-1507fcdd"), e = e(), bi(), e), Go = { class: "v-mail-signature-generator" }, Yo = { class: "fp-grid-container" }, Qo = { class: "fp-grid-coll-24-24 v-mail-signature-generator__child-no-margin" }, _o = /* @__PURE__ */ Oe(() => /* @__PURE__ */ O("h1", null, [
...
const Al = /* @__PURE__ */ Ko(Jo, [["render", dl], ["styles", [Fo]], ["__scopeId", "data-v-1507fcdd"]]);
function hl() {
