...
const st = (e) => q(e) ? e : e == null ? "" : P(e) || z(e) && (e.toString === Ps || !I(e.toString)) ? JSON.stringify(e, Cs, 2) : String(e), Cs = (e, t) => t && t.__v_isRef ? Cs(e, t.value) : Je(t) ? {
  [`Map(${t.size})`]: [...t.entries()].reduce((n, [s, r]) => (n[`${s} =>`] = r, n), {})
} : Os(t) ? {
  [`Set(${t.size})`]: [...t.values()]
} : z(t) && !P(t) && !Is(t) ? String(t) : t, B = {}, qe = [], fe = () => {
}, Er = () => !1, vr = /^on[^a-z]/, Ht = (e) => vr.test(e), En = (e) => e.startsWith("onUpdate:"), k = Object.assign, vn = (e, t) => {
  const n = e.indexOf(t);
  n > -1 && e.splice(n, 1);
}, Cr = Object.prototype.hasOwnProperty, S = (e, t) => Cr.call(e, t), P = Array.isArray, Je = (e) => Ut(e) === "[object Map]", Os = (e) => Ut(e) === "[object Set]", I = (e) => typeof e == "function", q = (e) => typeof e == "string", Cn = (e) => typeof e == "symbol", z = (e) => e !== null && typeof e == "object", Ts = (e) => z(e) && I(e.then) && I(e.catch), Ps = Object.prototype.toString, Ut = (e) => Ps.call(e), Or = (e) => Ut(e).slice(8, -1), Is = (e) => Ut(e) === "[object Object]", On = (e) => q(e) && e !== "NaN" && e[0] !== "-" && "" + parseInt(e, 10) === e, Pt = /* @__PURE__ */ xn(
  // the leading comma is intentional so empty string "" is also included
  ",key,ref,ref_for,ref_key,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted"
), $t = (e) => {
  const t = /* @__PURE__ */ Object.create(null);
  return (n) => t[n] || (t[n] = e(n));
}, Tr = /-(\w)/g, xe = $t((e) => e.replace(Tr, (t, n) => n ? n.toUpperCase() : "")), Pr = /\B([A-Z])/g, ie = $t((e) => e.replace(Pr, "-$1").toLowerCase()), As = $t((e) => e.charAt(0).toUpperCase() + e.slice(1)), Qt = $t((e) => e ? `on${As(e)}` : ""), Rt = (e, t) => !Object.is(e, t), It = (e, t) => {
  for (let n = 0; n < e.length; n++)
    e[n](t);
}, Nt = (e, t, n) => {
...
class Pn {
  ...
  run() {
    ...
    try {
      return this.parent = oe, oe = this, Pe = !0, Me = 1 << ++lt, lt <= cn ? Rr(this) : kn(this), this.fn();
    } finally {
      lt <= cn && Nr(this), Me = 1 << --lt, oe = this.parent, Pe = n, this.parent = void 0, this.deferStop && this.stop();
    }
  }
  stop() {
...
function Ns(e, t) {
  let n = !1;
  lt <= cn ? Fs(e) || (e.n |= Me, n = !Ms(e)) : n = !e.has(oe), n && (e.add(oe), oe.deps.push(e));
}
function we(e, t, n, s, r, i) {
  ...
  if (t === "clear")
    ...
    switch (n !== void 0 && c.push(o.get(n)), t) {
      case "add":
        P(e) ? On(n) && c.push(o.get("length")) : (c.push(o.get(Ke)), Je(e) && c.push(o.get(fn)));
        break;
      case "delete":
        P(e) || (c.push(o.get(Ke)), Je(e) && c.push(o.get(fn)));
        break;
      case "set":
        Je(e) && c.push(o.get(Ke));
        break;
    }
  if (c.length === 1)
    c[0] && un(c[0]);
...
function Ot(e, t, n) {
  return function(...s) {
    const r = this.__v_raw, i = j(r), o = Je(i), c = e === "entries" || e === Symbol.iterator && o, u = e === "keys" && o, d = r[e](...s), m = n ? An : t ? Sn : Nn;
...
function pi(e) {
  P(e) ? ke.push(...e) : (!_e || !_e.includes(e, e.allowRecurse ? $e + 1 : $e)) && ke.push(e), Js();
}
...
function Ys(e) {
  if (ke.length) {
    ...
    for (_e = t, _e.sort((n, s) => dt(n) - dt(s)), $e = 0; $e < _e.length; $e++)
      _e[$e]();
    _e = null, $e = 0;
  }
}
...
function ks(e) {
  ...
  try {
    ...
    ge = 0, Y.length = 0, Ys(), at = !1, jn = null, (Y.length || ke.length) && ks();
  }
}
function mi(e, t, ...n) {
  if (e.isUnmounted)
  ...
  if (o && o in s) {
    ...
    v && (r = n.map((A) => q(A) ? A.trim() : A)), w && (r = n.map(on));
  }
...
function Kt(e, t) {
  return !e || !Ht(t) ? !1 : (t = t.slice(2).replace(/Once$/, ""), S(e, t[0].toLowerCase() + t.slice(1)) || S(e, ie(t)) || S(e, t));
}
let le = null, Lt = null;
function St(e) {
  const t = le;
...
function Gt(e) {
  ...
  if (K && N !== !1) {
    ...
    J.length && Ce & 7 && (o && J.some(En) && (K = wi(K, o)), R = Xe(R, K));
  }
  return n.dirs && (R = Xe(R), R.dirs = R.dirs ? R.dirs.concat(n.dirs) : n.dirs), n.transition && (R.transition = n.transition), X = R, St(ve), X;
}
const yi = (e) => {
  let t;
  for (const n in e)
...
function Zs(e, t, { immediate: n, deep: s, flush: r, onTrack: i, onTrigger: o } = B) {
  ...
  let u, d = !1, m = !1;
  if (G(e) ? (u = () => e.value, d = an(e)) : Ye(e) ? (u = () => e, s = !0) : P(e) ? (m = !0, d = e.some((R) => Ye(R) || an(R)), u = () => e.map((R) => {
    if (G(R))
      return R.value;
    if (Ye(R))
      return De(R);
...
function Li(e) {
  ...
  if (pn = !0, i)
    for (const L in i) {
      const U = i[L], Ne = I(U) ? U.bind(n, n) : I(U.get) ? U.get.bind(n, n) : fe, xt = !I(U) && I(U.set) ? U.set.bind(n) : fe, Se = wo({
        get: Ne,
        set: xt
      });
  ...
  if (Z(Fi, w), Z(Ri, v), Z(Ni, A), Z(Si, D), Z(Ii, N), Z(Ai, X), Z(Bi, Fe), Z($i, Jt), Z(Ui, mt), Z(ji, ve), Z(nr, J), Z(Hi, Yt), P(Re))
    if (Re.length) {
      ...
      e.exposed || (e.exposed = {});
  Ce && e.render === fe && (e.render = Ce), tt != null && (e.inheritAttrs = tt), _t && (e.components = _t), bt && (e.directives = bt);
}
...
function Yi(e, t, n, s) {
  ...
  if (
    ...
    for (const w in c)
      ...
      ((m = ie(w)) === w || !S(t, m))) && (u ? n && // for camelCase
...
function rr(e, t, n, s) {
  ...
  if (t)
    for (let u in t) {
      ...
      const d = t[u];
      let m;
      r && S(r, m = xe(u)) ? !i || !i.includes(m) ? n[m] = d : (c || (c = {}))[m] = d : Kt(e.emitsOptions, u) || (!(u in s) || d !== s[u]) && (s[u] = d, o = !0);
    }
  if (i) {
    const u = j(n), d = c || B;
  ...
  if (o != null) {
    ...
    if (c && s === void 0) {
      ...
      if (o.type !== Function && I(u)) {
        ...
        n in d ? s = d[n] : (Ze(r), s = d[n] = u.call(null, t), Le());
      } else
        s = u;
    }
    o[
...
function ir(e, t, n = !1) {
  ...
  if (P(i))
    ...
    for (const m in i) {
      const w = xe(m);
      if (os(w)) {
        const v = i[m], A = o[w] = P(v) || I(v) ? { type: v } : Object.assign({}, v);
        if (A) {
          ...
          A[
            ...
            1
            /* BooleanFlags.shouldCastTrue */
          ] = N < 0 || D < N, (D > -1 || S(A, "default")) && c.push(w);
        }
      }
    }
  const d = [o, c];
...
function _n(e, t, n, s, r = !1) {
  if (P(e)) {
    e.forEach((v, A) => _n(v, t && (P(t) ? t[A] : t), n, s, r));
    return;
  }
  if (Mt(s) && !r)
    return;
  ...
  if (d != null && d !== u && (q(d) ? (m[d] = null, S(w, d) && (w[d] = null)) : G(d) && (d.value = null)), I(u))
    Ie(u, c, 12, [o, m]);
  else {
    const v = q(u), A = G(u);
    if (v || A) {
      const D = () => {
        if (e.f) {
          ...
          v ? (m[u] = o, S(w, u) && (w[u] = o)) : A && (u.value = o, e.k && (m[e.k] = o));
      };
      o ? (D.id = -1, ee(D, n)) : D();
    }
  }
...
function to(e, t) {
  ...
  const { insert: s, remove: r, patchProp: i, createElement: o, createText: c, createComment: u, setText: d, setElementText: m, parentNode: w, nextSibling: v, setScopeId: A = fe, insertStaticContent: D } = e, N = (l, f, a, p = null, h = null, b = null, y = !1, _ = null, x = !!f.dynamicChildren) => {
    if (l === f)
      return;
    l && !it(l, f) && (p = yt(l), ae(l, h, b, !0), l = null), f.patchFlag === -2 && (x = !1, f.dynamicChildren = null);
    ...
    switch (g) {
      ...
      case be:
        ...
        break;
      default:
        E & 1 ? Ce(l, f, a, p, h, b, y, _, x) : E & 6 ? bt(l, f, a, p, h, b, y, _, x) : (E & 64 || E & 128) && g.process(l, f, a, p, h, b, y, _, x, ze);
    }
    ...
    let x, g;
    const { type: C, props: E, shapeFlag: O, transition: T, dirs: M } = l;
    if (x = l.el = o(l.type, b, E && E.is, E), O & 8 ? m(x, l.children) : O & 16 && Fe(l.children, x, null, p, h, b && C !== "foreignObject", y, _), M && je(l, null, p, "created"), mt(x, l, l.scopeId, y, p), E) {
      for (const H in E)
        H !== "value" && !Pt(H) && i(x, H, null, E[H], b, l.children, p, h, me);
    ...
    $ && T.beforeEnter(x), s(x, f, a), ((g = E && E.onVnodeMounted) || $ || M) && ee(() => {
      g && he(g, p, l), $ && T.enter(x), M && je(l, null, p, "mounted");
    }, h);
  }, mt = (l, f, a, p, h) => {
    if (a && A(l, a), p)
    ...
    let T;
    a && He(a, !1), (T = O.onVnodeBeforeUpdate) && he(T, a, f, l), C && je(f, l, a, "beforeUpdate"), a && He(a, !0);
    const M = h && f.type !== "foreignObject";
    if (g ? Re(l.dynamicChildren, g, _, a, p, M, b) : y || U(l, f, _, null, a, p, M, b, !1), x > 0) {
      if (x & 16)
        tt(_, f, E, O, a, p, h);
    ...
    ((T = O.onVnodeUpdated) || C) && ee(() => {
      T && he(T, a, f, l), C && je(f, l, a, "updated");
    }, p);
  }, Re = (l, f, a, p, h, b, y) => {
    ...
    if (a !== p) {
      if (a !== B)
        for (const _ in a)
          !Pt(_) && !(_ in p) && i(l, _, a[_], null, y, f.children, h, b, me);
      for (const _ in p) {
        if (Pt(_))
          continue;
        const x = p[_], g = a[_];
    ...
    const _ = () => {
      if (l.isMounted) {
        let { next: C, bu: E, u: O, parent: T, vnode: M } = l, $ = C, H;
        He(l, !1), C ? (C.el = M.el, L(l, C, y)) : C = M, E && It(E), (H = C.props && C.props.onVnodeBeforeUpdate) && he(H, T, C, M), He(l, !0);
        ...
        l.subTree = W, N(
          ...
          h,
          b
        ), C.el = W.el, $ === null && vi(l, W.el), O && ee(O, h), (H = C.props && C.props.onVnodeUpdated) && ee(() => he(H, T, C, M), h);
      } else {
        let C;
        const { el: E, props: O } = f, { bm: T, m: M, parent: $ } = l, H = Mt(f);
        if (He(l, !1), T && It(T), !H && (C = O && O.onVnodeBeforeMount) && he(C, $, f), He(l, !0), E && Zt) {
          const W = () => {
    ...
    l.vnode = f, l.next = null, Yi(l, f.props, p, a), Zi(l, f.children, a), Qe(), ns(), Ge();
    ...
    T & 8 ? (C & 16 && me(g, h, b), E !== g && m(a, E)) : C & 16 ? T & 16 ? xt(g, E, a, p, h, b, y, _, x) : me(g, h, b, !0) : (C & 8 && m(a, ""), T & 16 && Fe(E, a, p, h, b, y, _, x));
  }, Ne = (l, f, a, p, h, b, y, _, x) => {
    l = l || qe, f = f || qe;
    const g = l.length, C = f.length, E = Math.min(g, C);
    let O;
    for (O = 0; O < E; O++) {
      const T = f[O] = x ? Te(f[O]) : pe(f[O]);
      N(l[O], T, a, null, h, b, y, _, x);
    }
    g > C ? me(l, h, b, !0, !1, E) : Fe(f, a, p, h, b, y, _, x, E);
  }, xt = (l, f, a, p, h, b, y, _, x) => {
    let g = 0;
    const C = f.length;
    let E = l.length - 1, O = C - 1;
    for (; g <= E && g <= O; ) {
      const T = l[g], M = f[g] = x ? Te(f[g]) : pe(f[g]);
      if (it(T, M))
        N(T, M, a, null, h, b, y, _, x);
      else
        break;
      g++;
    }
    for (; g <= E && g <= O; ) {
      const T = l[E], M = f[O] = x ? Te(f[O]) : pe(f[O]);
      if (it(T, M))
        N(T, M, a, null, h, b, y, _, x);
      else
        break;
    ...
    if (g > E) {
      if (g <= O) {
        const T = O + 1, M = T < C ? f[T].el : p;
        for (; g <= O; )
          N(null, f[g] = x ? Te(f[g]) : pe(f[g]), a, M, h, b, y, _, x), g++;
      }
    } else if (g > O)
      for (; g <= E; )
        ae(l[g], h, b, !0), g++;
    else {
      const T = g, M = g, $ = /* @__PURE__ */ new Map();
      for (g = M; g <= O; g++) {
        const ne = f[g] = x ? Te(f[g]) : pe(f[g]);
      ...
      for (g = T; g <= E; g++) {
        ...
        if (ne.key != null)
          ...
          for (H = M; H <= O; H++)
            if (nt[H - M] === 0 && it(ne, f[H])) {
              de = H;
              break;
            }
        de === void 0 ? ae(ne, h, b, !0) : (nt[de - M] = g + 1, de >= Wn ? Wn = de : We = !0, N(ne, f[de], a, null, h, b, y, _, x), W++);
      }
      const Vn = We ? no(nt) : qe;
      for (H = Vn.length - 1, g = se - 1; g >= 0; g--) {
        const ne = M + g, de = f[ne], qn = ne + 1 < C ? f[ne + 1].el : p;
        nt[g] === 0 ? N(null, de, a, qn, h, b, y, _, x) : We && (H < 0 || g !== Vn[H] ? Se(
          de,
          a,
          qn,
          2
    ...
    if (p !== 2 && g & 1 && _)
      if (p === 0)
        ...
        const { leave: E, delayLeave: O, afterLeave: T } = _, M = () => s(b, f, a), $ = () => {
          E(b, () => {
            M(), T && T();
          });
        };
    ...
    if (M && ($ = y && y.onVnodeBeforeUnmount) && he($, f, l), C & 6)
      ...
      T && je(l, null, f, "beforeUnmount"), C & 64 ? l.type.remove(l, f, a, h, ze, p) : g && // #1153: fast path should not be taken for non-stable (v-for) fragments
      (b !== be || E > 0 && E & 64) ? me(g, f, a, !1, !0) : (b === be && E & 384 || !h && C & 16) && me(x, f, a), p && Ln(l);
    }
    (M && ($ = y && y.onVnodeUnmounted) || T) && ee(() => {
      $ && he($, f, l), T && je(l, null, f, "unmounted");
    }, a);
  }, Ln = (l) => {
...
const so = (e) => e.__isTeleport, be = Symbol(void 0), Wt = Symbol(void 0), ht = Symbol(void 0), nn = Symbol(void 0), ft = [];
let ce = null;
function ro(e = !1) {
  ft.push(ce = e ? null : []);
}
...
function oo(e) {
  return e.dynamicChildren = pt > 0 ? ce || qe : null, io(), pt > 0 && ce && ce.push(e), e;
}
...
function F(e, t = null, n = null, s = 0, r = null, i = e === be ? 0 : 1, o = !1, c = !1) {
  const u = {
    __v_isVNode: !0,
    __v_skip: !0,
    type: e,
...
function fo(e, t = null, n = null, s = 0, r = null, i = !1) {
  if ((!e || e === Di) && (e = ht), co(e)) {
    ...
    return n && Bn(c, n), pt > 0 && !i && ce && (c.shapeFlag & 6 ? ce[ce.indexOf(e)] = c : ce.push(c)), c.patchFlag |= -2, c;
  }
  ...
  const o = q(e) ? 1 : Ci(e) ? 128 : so(e) ? 64 : z(e) ? 4 : I(e) ? 2 : 0;
...
function Bn(e, t) {
  ...
  if (t == null)
    ...
    I(t) ? (t = { default: t, _ctx: le }, n = 32) : (t = String(t), s & 64 ? (n = 16, t = [ye(t)]) : n = 8);
...
}), Jo = `.v-mail-signature-generator[data-v-3a9b6786]{--wcm-line-height: 20px;--wcm-font-size: 18px;max-width:30em;font-family:sans-serif;min-height:calc(100vh - 200px);padding-bottom:var(--wcm-line-height);font-size:var(--wcm-font-size);line-height:var(--wcm-line-height);margin:auto}.v-mail-signature-generator .v-mail-signature-generator__container[data-v-3a9b6786]{padding:var(--wcm-line-height);margin-bottom:var(--wcm-line-height);background:white}.v-mail-signature-generator .v-mail-signature-generator__container>*[data-v-3a9b6786]::-moz-selection{color:#20b2aa;background:#b0fdf6}.v-mail-signature-generator .v-mail-signature-generator__container>*[data-v-3a9b6786] ::selection{color:#20b2aa;background:#b0fdf6}.v-mail-signature-generator .v-mail-signature-generator__container>table[data-v-3a9b6786]{pointer-events:none}h1[data-v-3a9b6786]{font-size:calc(var(--wcm-font-size) * 2);line-height:calc(var(--wcm-line-height) * 2)}.v-mail-signature-generator__child-no-margin>*[data-v-3a9b6786]:first-child{margin-top:0}.v-mail-signature-generator__child-no-margin>*[data-v-3a9b6786]:last-child{margin-bottom:0}.fp-grid-container[data-v-3a9b6786],.fp-ui-form[data-v-3a9b6786]{display:flex;flex-wrap:wrap}.fp-ui-form>input[data-v-3a9b6786]{all:unset;display:block;position:relative;width:100%;cursor:pointer;box-sizing:border-box;box-shadow:inset 0 0 0 2px currentColor;padding:calc(var(--wcm-line-height) / 2);margin-bottom:var(--wcm-line-height)}.fp-grid-coll-24-24[data-v-3a9b6786]{width:100%}.fp-ui-button[data-v-3a9b6786]{all:unset;line-height:var(--wcm-line-height);font-size:var(--wcm-font-size);font-weight:400;margin:0 auto;cursor:pointer;display:block;box-sizing:border-box;box-shadow:inset 0 0 0 2px currentColor;padding:calc(var(--wcm-line-height) / 2) calc(var(--wcm-line-height))}
`, Yo = (e, t) => {
  const n = e.__vccOpts || e;
  for (const [s, r] of t)
    n[s] = r;
  return n;
}, et = (e) => (_i("data-v-3a9b6786"), e = e(), bi(), e), ko = { class: "v-mail-signature-generator" }, Xo = { class: "fp-grid-container" }, Zo = { class: "fp-grid-coll-24-24 v-mail-signature-generator__child-no-margin" }, Qo = /* @__PURE__ */ et(() => /* @__PURE__ */ F("h1", null, [
  /* @__PURE__ */ ye("Générateur"),
  /* @__PURE__ */ F("br"),
  /* @__PURE__ */ ye("de signature mail pour"),
  /* @__PURE__ */ F("br"),
  /* @__PURE__ */ ye("la Fondation Modus")
...
}, sl = /* @__PURE__ */ et(() => /* @__PURE__ */ F("br", null, null, -1)), rl = /* @__PURE__ */ et(() => /* @__PURE__ */ F("tr", null, [
  /* @__PURE__ */ F("td", {
    height: "auto",
    ...
    /* @__PURE__ */ F("strong", null, [
      /* @__PURE__ */ ye("Fondation Modus, "),
      /* @__PURE__ */ F("br"),
      /* @__PURE__ */ ye("pour une mobilité durable à Genève")
    ])
  ])
], -1)), il = {
  height: "auto",
  style: { "font-family": "Helvetica, Arial, sans-serif", padding: "15px 0 0", "line-height": "15px", "font-size": "12px", color: "black" }
}, ol = ["href"], ll = /* @__PURE__ */ et(() => /* @__PURE__ */ F("br", null, null, -1)), cl = ["href"], fl = /* @__PURE__ */ et(() => /* @__PURE__ */ F("tr", null, [
  /* @__PURE__ */ F("td", {
    border: "0",
    cellpadding: "0",
    cellspacing: "0",
...
], -1)), ul = /* @__PURE__ */ et(() => /* @__PURE__ */ F("p", null, [
  /* @__PURE__ */ ye(" Une fois le texte sélectionné (le texte devient vert quand il est sélectionné), copiez-le et collez-le dans votre "),
  /* @__PURE__ */ F("br"),
  /* @__PURE__ */ ye("outil de messagerie mail, dans les paramètres de signatures automatiques. ")
], -1));
          ...
          F("div", el, [
            F("table", tl, [
              F("tbody", null, [
                F("tr", null, [
                  F("td", nl, [
                    F("strong", null, st(e.getCleanedEmptyString(e.firstname, "Votre prénom")) + " " + st(e.getCleanedEmptyString(e.name, "/ Votre nom")), 1),
                    sl,
                    ye(" " + st(e.getCleanedEmptyString(e.activity, "Votre fonction")), 1)
                  ])
                ]),
                rl,
                F("tr", null, [
                  F("td", il, [
                    ...
                    }, "T " + st(e.getCleanedEmptyString(e.tel, "Votre numéro")), 9, ol),
                    ll,
                    F("a", {
                      href: "mailto:" + e.mail,
                      style: { "text-decoration": "none", color: "black" }
...
const dl = /* @__PURE__ */ Yo(qo, [["render", al], ["styles", [Jo]], ["__scopeId", "data-v-3a9b6786"]]);
function hl() {
  customElements.define("mail-signature", Ko(dl));
}
export {
  hl as register
};
