...
const bt = (e) => J(e) ? e : e == null ? "" : q(e) || I(e) && (e.toString === qr || !j(e.toString)) ? JSON.stringify(e, zr, 2) : String(e), zr = (e, t) => t && t.__v_isRef ? zr(e, t.value) : Ke(t) ? {
...
function hi(e) {
  q(e) ? Ye.push(...e) : (!be || !be.includes(e, e.allowRecurse ? Be + 1 : Be)) && Ye.push(e), Fr();
}
...
function Kr(e) {
  if (Ye.length) {
    ...
    for (be = t, be.sort((n, r) => ut(n) - ut(r)), Be = 0; Be < be.length; Be++)
      be[Be]();
    be = null, Be = 0;
  }
}
...
function to(e, t) {
  const n = js();
  n.__VUE__ = !0;
  const { insert: r, remove: s, patchProp: i, createElement: o, createText: f, createComment: c, setText: d, setElementText: v, parentNode: P, nextSibling: x, setScopeId: T = ue, insertStaticContent: k } = e, D = (l, u, a, h = null, A = null, b = null, w = !1, m = null, g = !!u.dynamicChildren) => {
    if (l === u)
      return;
    l && !rt(l, u) && (h = mt(l), ae(l, A, b, !0), l = null), u.patchFlag === -2 && (g = !1, u.dynamicChildren = null);
    ...
    switch (p) {
      ...
      case nn:
        ...
        break;
      case ge:
        ht(l, u, a, h, A, b, w, m, g);
        break;
      default:
        y & 1 ? ze(l, u, a, h, A, b, w, m, g) : y & 6 ? pt(l, u, a, h, A, b, w, m, g) : (y & 64 || y & 128) && p.process(l, u, a, h, A, b, w, m, g, Re);
    }
    ...
    for (; l && l !== u; )
      a = x(l), s(l), l = a;
    s(u);
  }, ze = (l, u, a, h, A, b, w, m, g) => {
    w = w || u.type === "svg", l == null ? Ft(u, a, h, A, b, w, m, g) : Kt(l, u, A, b, w, m, g);
  }, Ft = (l, u, a, h, A, b, w, m) => {
    let g, p;
    const { type: z, props: y, shapeFlag: X, transition: H, dirs: N } = l;
    if (g = l.el = o(l.type, b, y && y.is, y), X & 8 ? v(g, l.children) : X & 16 && We(l.children, g, null, h, A, b && z !== "foreignObject", w, m), N && Ve(l, null, h, "created"), At(g, l, l.scopeId, w, h), y) {
      for (const V in y)
        V !== "value" && !qt(V) && i(g, V, null, y[V], b, l.children, h, A, me);
  ...
  }, We = (l, u, a, h, A, b, w, m, g = 0) => {
    for (let p = g; p < l.length; p++) {
      const z = l[p] = m ? He(l[p]) : he(l[p]);
      D(null, z, u, a, h, A, b, w, m);
    }
  }, Kt = (l, u, a, h, A, b, w) => {
    const m = u.el = l.el;
    ...
    if (p ? De(l.dynamicChildren, p, m, a, h, N, b) : w || L(l, u, m, null, a, h, N, b, !1), g > 0) {
      if (g & 16)
        tt(m, u, y, X, a, h, A);
        ...
        for (let V = 0; V < Z.length; V++) {
          ...
          (Me !== re || R === "value") && i(m, R, re, Me, A, l.children, a, h, me);
        }
      }
      g & 1 && l.children !== u.children && v(m, u.children);
    } else
      !w && p == null && tt(m, u, y, X, a, h, A);
    ...
    for (let m = 0; m < u.length; m++) {
      ...
      D(g, p, z, null, h, A, b, w, !0);
    }
  }, tt = (l, u, a, h, A, b, w) => {
    if (a !== h) {
      if (a !== B)
        for (const m in a)
          !qt(m) && !(m in h) && i(l, m, a[m], null, w, u.children, A, b, me);
      for (const m in h) {
        if (qt(m))
          continue;
        const g = h[m], p = a[m];
        g !== p && m !== "value" && i(l, m, p, g, w, u.children, A, b, me);
      }
    ...
    H && (m = m ? m.concat(H) : H), l == null ? (r(p, a, h), r(z, a, h), We(u.children, a, z, A, b, w, m, g)) : y > 0 && y & 64 && X && // #2715 the previous fragment could've been a BAILed one as a result
    // of renderSlot() with no valid children
    l.dynamicChildren ? (De(l.dynamicChildren, X, a, A, b, w, m), // #2080 if the stable fragment has a key, it's a <template v-for> that may
  ...
  }, pt = (l, u, a, h, A, b, w, m, g) => {
    u.slotScopeIds = m, l == null ? u.shapeFlag & 512 ? A.ctx.activate(u, a, h, w, g) : Gt(u, a, h, A, b, w, g) : Sn(l, u, g);
  }, Gt = (l, u, a, h, A, b, w) => {
    const m = l.component = po(l, h, A);
    if (es(l) && (m.ctx.renderer = Re), vo(m), m.asyncDep) {
  ...
  }, L = (l, u, a, h, A, b, w, m, g = !1) => {
    const p = l && l.children, z = l ? l.shapeFlag : 0, y = u.children, { patchFlag: X, shapeFlag: H } = u;
    if (X > 0) {
      if (X & 128) {
        vt(p, y, a, h, A, b, w, m, g);
        return;
      } else if (X & 256) {
        Ce(p, y, a, h, A, b, w, m, g);
        return;
      }
    }
    H & 8 ? (z & 16 && me(p, A, b), y !== p && v(a, y)) : z & 16 ? H & 16 ? vt(p, y, a, h, A, b, w, m, g) : me(p, A, b, !0) : (z & 8 && v(a, ""), H & 16 && We(y, a, h, A, b, w, m, g));
  }, Ce = (l, u, a, h, A, b, w, m, g) => {
    l = l || Fe, u = u || Fe;
    ...
    p > z ? me(l, A, b, !0, !1, y) : We(u, a, h, A, b, w, m, g, y);
  }, vt = (l, u, a, h, A, b, w, m, g) => {
    let p = 0;
    const z = u.length;
    ...
    if (p > y) {
      if (p <= X) {
        ...
        for (; p <= X; )
          D(null, u[p] = g ? He(u[p]) : he(u[p]), a, N, A, b, w, m, g), p++;
      }
    } else if (p > X)
      for (; p <= y; )
        ae(l[p], A, b, !0), p++;
      ...
      for (p = H; p <= y; p++) {
        ...
        de === void 0 ? ae(ne, A, b, !0) : (nt[de - N] = p + 1, de >= Rn ? Rn = de : Me = !0, D(ne, u[de], a, null, A, b, w, m, g), R++);
      }
      const Mn = Me ? no(nt) : Fe;
      for (V = Mn.length - 1, p = re - 1; p >= 0; p--) {
        const ne = N + p, de = u[ne], Jn = ne + 1 < z ? u[ne + 1].el : h;
        nt[p] === 0 ? D(null, de, a, Jn, A, b, w, m, g) : Me && (V < 0 || p !== Mn[V] ? Ee(
          de,
          a,
          Jn,
          2
    ...
    const { el: b, type: w, transition: m, children: g, shapeFlag: p } = l;
    if (p & 6) {
    ...
    const { type: b, props: w, ref: m, children: g, dynamicChildren: p, shapeFlag: z, patchFlag: y, dirs: X } = l;
    ...
    if (N && (Z = w && w.onVnodeBeforeUnmount) && Ae(Z, u, l), z & 6)
      ...
      (b !== ge || y > 0 && y & 64) ? me(p, u, a, !1, !0) : (b === ge && y & 384 || !A && z & 16) && me(g, u, a), h && Un(l);
    }
    ...
    const { bum: h, scope: A, update: b, subTree: w, um: m } = l;
    h && jt(h), A.stop(), b && (b.active = !1, ae(w, l, u, a)), m && ee(m, u), ee(() => {
      l.isUnmounted = !0;
    }, u), u && u.pendingBranch && !u.isUnmounted && l.asyncDep && !l.asyncResolved && l.suspenseId === u.pendingId && (u.deps--, u.deps === 0 && u.resolve());
  }, me = (l, u, a, h = !1, A = !1, b = 0) => {
...
}), Fo = `.v-mail-signature-generator[data-v-c7d14116]{--wcm-line-height: 20px;--wcm-font-size: 18px;max-width:30em;font-family:sans-serif;min-height:calc(100vh - 200px);padding-bottom:var(--wcm-line-height);font-size:var(--wcm-font-size);line-height:var(--wcm-line-height);margin:auto}.v-mail-signature-generator .v-mail-signature-generator__container[data-v-c7d14116]{padding:var(--wcm-line-height);margin-bottom:var(--wcm-line-height);background:white}.v-mail-signature-generator .v-mail-signature-generator__container>*[data-v-c7d14116]::-moz-selection{color:#20b2aa;background:#b0fdf6}.v-mail-signature-generator .v-mail-signature-generator__container>*[data-v-c7d14116] ::selection{color:#20b2aa;background:#b0fdf6}.v-mail-signature-generator .v-mail-signature-generator__container>table[data-v-c7d14116]{pointer-events:none}h1[data-v-c7d14116]{font-size:calc(var(--wcm-font-size) * 2);line-height:calc(var(--wcm-line-height) * 2)}.v-mail-signature-generator__child-no-margin>*[data-v-c7d14116]:first-child{margin-top:0}.v-mail-signature-generator__child-no-margin>*[data-v-c7d14116]:last-child{margin-bottom:0}.fp-grid-container[data-v-c7d14116],.fp-ui-form[data-v-c7d14116]{display:flex;flex-wrap:wrap}.fp-ui-form>input[data-v-c7d14116]{all:unset;display:block;position:relative;width:100%;cursor:pointer;box-sizing:border-box;box-shadow:inset 0 0 0 2px currentColor;padding:calc(var(--wcm-line-height) / 2);margin-bottom:var(--wcm-line-height)}.fp-grid-coll-24-24[data-v-c7d14116]{width:100%}.fp-ui-button[data-v-c7d14116]{all:unset;line-height:var(--wcm-line-height);font-size:var(--wcm-font-size);font-weight:400;margin:0 auto;cursor:pointer;display:block;box-sizing:border-box;box-shadow:inset 0 0 0 2px currentColor;padding:calc(var(--wcm-line-height) / 2) calc(var(--wcm-line-height))}
`, Ko = (e, t) => {
  const n = e.__vccOpts || e;
  for (const [r, s] of t)
    n[r] = s;
  return n;
}, Oe = (e) => (mi("data-v-c7d14116"), e = e(), bi(), e), Go = { class: "v-mail-signature-generator" }, Yo = { class: "fp-grid-container" }, Qo = { class: "fp-grid-coll-24-24 v-mail-signature-generator__child-no-margin" }, _o = /* @__PURE__ */ Oe(() => /* @__PURE__ */ O("h1", null, [
...
const Al = /* @__PURE__ */ Ko(Jo, [["render", dl], ["styles", [Fo]], ["__scopeId", "data-v-c7d14116"]]);
function hl() {
